...
class MakeParallelLRNet(MakeNet):


    def __init__(self,pinyin,precision=np.double):
        MakeNet.__init__(self,pinyin)
        ...
        self.transitionVaryingProbLoopEnterTrans    = np.array(transitionVaryingProbLoopEnterTrans)*0.1
        self.transitionVaryingProbLoopSkipTrans     = np.array(transitionVaryingProbLoopSkipTrans)*0.1

        self.transitionVaryingProbLastLoopEnterTrans    = np.array(transitionVaryingProbLoopEnterTrans)*0.1
        self.transitionVaryingProbLastLoopSelfTrans     = np.array(transitionVaryingProbLoopSkipTrans)*0.1+0.9
