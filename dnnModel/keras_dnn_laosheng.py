...
filename_train_set = '/scratch/rgongDNNAcousticModel/phonemeSeg/train_set_laosheng_phonemeSeg_mfcc_neighbor.pickle.gz'
filename_train_validation_set = '/scratch/rgongDNNAcousticModel/phonemeSeg/train_set_all_laosheng_phonemeSeg_mfcc_neighbor.pickle.gz'
filename_validation_set = '/scratch/rgongDNNAcousticModel/phonemeSeg/validation_set_laosheng_phonemeSeg_mfcc_neighbor.pickle.gz'
...
if __name__ == '__main__':
    ...
    model_0 = f_nn_model(475, 0.291, 400)
    ...
    model_1 = f_nn_model(475, 0.291, 400)
    ...
    model_1.save('/scratch/rgongDNNAcousticModel/out/keras.dnn_3_optim_laosheng_mfcc_neighbor_all.h5')

    # with gzip.open('loss_and_metrics.pkl.gz', 'wb') as f:
    #     cPickle.dump(loss_and_metrics, f)